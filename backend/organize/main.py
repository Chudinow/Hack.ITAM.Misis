...
# Импортируем роутеры
from routers.organizer_auth import router as organizer_auth_router
from routers.organizer_hackathons import router as organizer_hackathons_router
from routers.organizer_teams import router as organizer_teams_router
